...
- [x] footer 사업자 정보 + 전화번호 (전자상거래법)
- [x] 환불/취소 정책 상세화 (100% 만족 보장 3단계)
- [x] FAQ 섹션 7개 (아코디언, 주문 폼 위)
- [x] 카카오톡 채팅 플로팅 버튼 (pf.kakao.com/_fUyqX)
- [x] favicon 추가 (인라인 SVG)
- [x] 업로드 카운트 불일치 버그 수정
...
### 통신판매업 신고
- [x] 사업자등록증 ✅ (일반과세자, 292-32-01725)
- [x] 구매안전서비스 이용확인증 — NHN KCP 에스크로 확인증 발급 완료 (제 A11-260306-9597 호)
...
### 버그
- [x] ~~업로드 카운트 불일치~~ (2026-03-08 수정)
- [x] ~~"10~20분 소요" 표시~~ (2026-03-08 수정)
- [x] ~~favicon.ico 404 에러~~ (2026-03-08 인라인 SVG 추가)

### 개선
- [ ] Grok 프롬프트 튜닝 (얼굴 보존 강화, 현재 70점)
- [x] ~~footer에 연락처(전화번호) 추가~~ (2026-03-08)
- [ ] footer에 통신판매신고번호 추가 (발급 후)
- [ ] og:image 소셜 공유 썸네일
- [ ] 샘플 영상 교체 (실 서비스 영상으로)
- [x] ~~FAQ 섹션 추가~~ (2026-03-08 7개 아코디언)
- [ ] 리뷰 섹션 추가 (런칭 후)
